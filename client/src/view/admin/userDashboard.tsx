            ...
            <header className="text-gray-600 body-font">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                        ...
                        <span className="ml-3 text-xl">Hi ! {userData.name}</span>
                    </a>
                    ...
                    {/*<button onClick={this.logOut} className={"border-2 bg-gray-400 p-2 border-black"}>Log Out</button>*/}
                    <button
                        onClick={this.logOut} className="inline-flex items-center bg-gray-100 border-0 py-1 px-3
            ...
            <section className="text-gray-600 body-font">
                    <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                        ...
                        <div
                            ...
                            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Lace-up and ready to go!
                            ...
                            <div className="flex justify-center">
                                <button
                                    className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Shop
                                </button>
                                {/*<button*/}
                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20">
                        <h2 className="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">ROOF PARTY
                            POLAROID</h2>
                        <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900">Master Cleanse Reliac
                            Heirloom</h1>
                    </div>
                    <div className="flex flex-wrap -m-4">
