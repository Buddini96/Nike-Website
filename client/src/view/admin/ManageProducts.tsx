            ...
            <>
                <div className={"relative flex min-h-screen"}>
                    ...
                    <div className={"flex-1"}>
                        {/*header*/}
                        <div className={"flex justify-between items-center max-container text-cyan-700 font-extrabold bg-white shadow px-8 py-4"}>Manage Products
                        ...
                        <div className={"p-9"}>
                            <div className={"container border-black p-[10px]  max-w-[700px] m-auto rounded-md"}>
                                <button className={"bg-cyan-700 text-white p-1 rounded-md px-2"}
                                    // @ts-ignore
                                        onClick={() => this.setState({ addSection: true })}>Add</button>


                                {
                                    addSection && (
                                        <div className={"absolute right-0 left-0 top-0 bottom-0 flex justify-center items-center"}>
                                            <form onSubmit={handleSubmit} className={"h-auto p-2 justify-center bg-[#f1f5f9] p-9 items-center rounded-md shadow-2xl"}>
                                                <FontAwesomeIcon
                                                    icon={faXmark}
                                                ...
                                                />
                                                <div className={"pb-2"}>
                                                    <label className={"text-12px pl-5 p-5"} htmlFor={""}>Product Id : </label>
                                                    <input className={"float-right border-[2px] border-teal-700"} type={"email"}/>
                                                </div>

                                                <div className={"pb-2"}>
                                                    <label className={"text-12px pl-5"} htmlFor={""}>Name : </label>
                                                    <input className={"float-right border-[2px] border-teal-700"} type={"text"}/>
                                                </div>
                                                ...
                                                <div className={"mt-2 pl-20  w-full"}>
                                                    <button className={"p-1 items-start  w-full bg-teal-700 text-[14px] mt-5 rounded-md text-white font-bold hover:bg-black"} type={"button"}>
                                                        Submit
                                                    </button>
                                                </div>
                                            </form>
