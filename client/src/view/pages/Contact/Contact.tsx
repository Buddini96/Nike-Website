                    ...
                    <div className={"mb-16 flex flex-col md:flex-row md:space-x-8 md:space-y-0 space-y-6 bg-coral-red " +
                        ...
                        <div className={"flex flex-col space-y-8 justify-between "}>
                            <div>
                                ...
                                <p className={"pt-5 text-cyan-100 text-[15px]"}>Step into hassle-free assistance! Reach
                                    out to us for </p> <p className={"text-cyan-100 text-[15px]"}>any queries or support - your comfort is our priority. 👟✨
                                <p>Our experts are just a message away to assist with any questions.</p>
                            </p>
                            </div>
                            {/*icons*/}
                            <div className={"flex flex-col space-y-6"}>
                                <div className={"inline-flex flex-1 space-x-2 items-center"}>
                                    <svg name={"call"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                         fill="currentColor" className="w-6 h-6 text-teal-300 text-xl">
                                        <path fillRule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586
                                        1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694
                                        ...
                                        15.448 1.5 6.75V4.5Z" clipRule="evenodd" />
                                    </svg>
                                    <span>+(94) 76 886 1459</span>
                                </div>

                                <div className={"inline-flex flex-1 space-x-2 items-center"}>
                                    <svg name={"mail"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                         fill="currentColor" className="w-6 h-6 text-teal-300 text-xl">
                                        <path d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928
                                        5.493a3 3 0 0 1-3.144 0L1.5 8.67Z" />
                                        <path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714
                                        5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z" />
                                    </svg>
                                    <span>www.nike.com</span>
                                </div>

                                <div className={"inline-flex flex-1 space-x-2 items-center"}>
                                    <svg name={"location"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                         fill="currentColor" className="w-6 h-6 text-teal-300 text-xl">
                                        <path fillRule="evenodd" d="m11.54 22.351.07.04.028.016a.76.76 0 0
                                        0 .723 0l.028-.015.071-.041a16.975 16.975 0 0 0 1.144-.742 19.58 19.58
                                        0 0 0 2.683-2.282c1.944-1.99 3.963-4.98 3.963-8.827a8.25 8.25 0 0 0-16.5
                                        0c0 3.846 2.02 6.837 3.963 8.827a19.58 19.58 0 0 0 2.682 2.282 16.975 16.975
                        ...
                        <div className={"relative"}>
                            ...
                            <div className={"relative z-10 bg-white rounded-xl shadow-lg p-8 text-gray-600 md:w-120"}>
